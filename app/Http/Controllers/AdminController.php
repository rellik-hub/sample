...
class AdminController extends Controller
{
    ...
    public function index () {
        ...
        // $users = Users::all();
        // $rooms = Room::all();
        // $schedule = Schedule_subject::all();
        // $checklist = Checklist::all();
        // $colleges = Colleges::all();
        // $faculty = PersonalDataSheet::all();
        // , compact('courses', 'users', 'rooms', 'schedule', 'checklist', 'colleges', 'faculty')
    ...
    public function room_utilization () {
        ...
        $courses = Courses::all();
        return view ('admin panel.room_utilization', compact('room', 'schedule_subject', 'courses'));
    }
