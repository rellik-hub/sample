...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="flex-center position-ref full-height">
            <img src="{{ asset('picture/download.png') }}" style="padding: 50px; width:50%;height:70%;"> 
            @if (Route::has('login'))
            ...
            <div class="content">
                <div class="title m-b-md">
                   ...
                   <u> <br><br><h1 style="font-family:'Courier New', Courier, monospace">Class Scheduler System</h1></u>
                        <div class="links">
