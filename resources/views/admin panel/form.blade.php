							...
							@csrf
									...
									<label class="control-label" for="basicinput" style="margin:5px">DATE OF BIRTH:</label>
										<div class="controls"style="margin:1px">
												...
												<select tabindex="1" data-placeholder="Select here.." name="month" class="form-control input-lg span2",  >
												...
												<select tabindex="1" data-placeholder="Select here.." name="day" class="form-control input-lg span1",  >
												...
												<select tabindex="1" data-placeholder="Select here.." name="year" class="form-control input-lg span2",  >
												...
												<div class="controls" style="margin:5px">
													<select tabindex="1" data-placeholder="" name="colleges" class="form-control input-lg span2">
														@foreach( $colleges as $value )
															<option value="{{ $value->college_acronym }}" {{ old('colleges')=== $value->college_acronym ? 'selected' : ''}}>{{ $value->college_acronym }}</option>
														@endforeach
													</select>
													@error('colleges')
														<span style="color:red !important;">{{ $message }}</span>
												...
												<div class="controls" style="margin:5px">
													<select tabindex="1" data-placeholder="" name="department" class="form-control input-lg span2">
														@foreach( $department as $value )
															<option value="{{ $value->department_acronym }}" {{ old('department')=== $value->department_acronym ? 'selected' : ''}}>{{ $value->department_acronym }}</option>
														@endforeach
													</select>
													@error('department')
														<span style="color:red !important;">{{ $message }}</span>
										...
										<div class="control-group">
											...
											<a name="show" class="btn btn-primary" style="float:right; display:block; width:23%; margin:5px;">optional fields</a>
											<a name="hide" class="btn btn-primary" style="float:right; display:block; width:23%; margin:5px;">hide optional fields</a>
											 </div>
