...
<div class="span9">
    <div class="content" style="float:align-left">
        ...
        <div id="header" class="module">
            ...
            <form  class="form-horizontal row-fluid" method="POST" action="{{route('course_ctrl.update', $data->id)}}">
                @csrf				
                @method('PATCH')
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <label class="control-label" for="basicinput" style="margin:5px">COURSE CODE:  </label>
                                    <div class="controls" style="margin:5px">
                                        <input type="text" id="basicinput" placeholder="" value="{{$data->course_code}}" name="course_code" class="form-control input-lg span2", required>
                                            @error('course_code')
                            ...
                            <tr>
                                <label class="control-label" for="basicinput" style="margin:5px">COURSE DESCRIPTION:  </label>
                                    <div class="controls" style="margin:5px">
                                        <input type="text" id="basicinput" placeholder="" value="{{$data->course_desription}}" name="course_desription" class="form-control input-lg span8", required>
