...
Route::prefix('admin')->group(function() {
    ...
    Route::get('/room_utilization',        'AdminController@room_utilization')->name('room_utilization');
});
 ...
 Route::group(['middleware' => ['auth']], function(){
    ...
    Route::get('/print_checklist',   'ChecklistController@print_checklist')->name('print_checklist');
