                    ...
                    <table id="subject_table" cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
                        ...
                        <tbody>
                            @foreach($check as $subjects)
                                ...
                                <tr>
                                    <td><input type="text" id="course_code" placeholder="" name="course_code[]" value="{{  $subjects->course_code }}" class="form-control input-lg span2", required></td>
                                            <td><input type="text" id="course_description" placeholder="" name="course_description[]" value="{{  $subjects->course_description }}" class="form-control input-lg span3", required></td>
